...
@Configurable
@Disabled
@Autonomous(name = "Blue Near Auto", group = "Blue Auto")
public class BlueNearAuto extends OpMode {

    public static boolean openGateAfterPickup1 = true;
    ...
    private final double launchPower = 0.665;
    ...
    private final Pose pickup1PoseEnd = new Pose(128, 84, Math.toRadians(0)).mirror();
    ...
    private final Pose scorePose2 = new Pose(96, 96, Math.toRadians(45)).mirror();
    ...
    private final Pose pickup3Pose = new Pose(96, 36, Math.toRadians(0)).mirror();
        ...
        switch (pathState) {
            ...
            case 2 -> {
                if (!follower.isBusy()) {
                    ...
                    intakeLauncher.powerOnLauncher(0.653);
                    setPathState(3);
                }
            }
            case 3 -> {
