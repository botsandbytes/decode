...
//    private DcMotorEx intakeMid;
    ...
    private static final double DISTANCE_THRESHOLD = 27.5; // cm, make it slightly shorter than funnel length
...
//                    intakeMid.setPower(0);
                ...
                if (distance < DISTANCE_THRESHOLD && distance < 100) {
                    // ignore anything ridiculously far away
